    ...
    <div>
      <section class="w-screen h-screen bg-busmap bg-cover bg-center px-4 relative">
        <Navbar fluid={true} rounded={true} class="bg-transparent ">
          ...
          <Navbar.Collapse>
            <Navbar.Link
              class=" block py-2 pr-4 pl-3 text-teal rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-teal  md:p-0 dark:text-teal md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent text-lg font-bold"
              href="#/"
            >
              About us
            </Navbar.Link>
